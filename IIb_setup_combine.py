...
class CombineDrugsSetup:
    def __init__(
        self, config: AssayConfiguration, experiment: Experiment, combination_idx: int
    ):
        ...
        drugs = [
            self.config.combinations[combination_idx]["a"],
            self.config.combinations[combination_idx]["b"],
        ]
        self.drugs = drugs
    ...
    def define_antibiotic_plate(
        self,
        combination_idx,
    ):
        combination = self.config.combinations[combination_idx]
